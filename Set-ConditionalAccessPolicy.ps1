...
Get-Mailbox | Set-CASMailbox -OwaMailboxPolicy "WSW | OWA | Prohibit Download"

# SharePoint Online:
Connect-SPOService -Url https://tenantname-admin.sharepoint.com

# List all sites en show conditional accesss status
Get-SPOSite | foreach{ Get-SPOSite -Detailed -Identity $_.URL | select Url,Conditional* }
...
$sites = Get-SPOSite -Limit all -Filter "Url -like '9292.sharepoint.com/sites'"
